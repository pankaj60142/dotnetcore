...
The dEnterpriseAtlas project is compatible to run hosted in Azure. The following sections describe the steps needed to get the SmartAdmin for ASP.NET Core web app running in Azure as you develop.
