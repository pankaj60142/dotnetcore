...
(function(undefined) {
    ...
    var commandsList = [],
        ...
        commandToRegExp = function(command) {
            command = command.replace(escapeRegExp, "\\$&").replace(optionalParam, "(?:$1)?").replace(namedParam,
    ...
    root.smartSpeechRecognition = {
        ...
        init: function(commands, resetCommands) {
            ...
            recognition.onstart = function() {
                ...
                //debugState
                if (debugState) {
                    root.console.log("%c ✔ SUCCESS: User allowed access the microphone service to start ",
                        debugStyle_success);
