 ...
 * Sets the default font size.
 */
Menus.prototype.defaultMenuItems = ['file', 'edit', 'view', 'arrange', 'extras', 'help', 'newmenu'];
...
Menus.prototype.init = function()
{
	...
	{
		this.addMenuItems(menu, ['new', 'open', '-', 'ddd', 'saveAs', '-', 'import', 'export', '-', 'pageSetup', 'print'], parent);
	})));
	...
	this.put('newmenu', new Menu(mxUtils.bind(this, function (menu, parent) {
	    this.addMenuItems(menu, ['newmenu', '-', 'new1']);
	})));
};
