...
Actions.prototype.init = function () {
    ...
    this.addAction('save', function () { ui.saveFile(false, window.parent.document.getElementById("tempSelectedFolderId").innerHTML) }, null, null, Editor.ctrlKey + '+S').isEnabled = isGraphEnabled;
    this.addAction('saveAs...', function () { ui.saveFile(true, window.parent.document.getElementById("tempSelectedFolderId").innerHTML); }, null, null, Editor.ctrlKey + '+Shift+S').isEnabled = isGraphEnabled;
    this.addAction('export...', function () { ui.showDialog(new ExportDialog(ui).container, 300, 280, true, true); });
