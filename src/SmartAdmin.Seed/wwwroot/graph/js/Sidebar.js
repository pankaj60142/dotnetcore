...
Sidebar.prototype.init = function () {
    ...
    { title: mxResources.get('arrows'), id: 'arrows', image: IMAGE_PATH + '/sidebar-arrows2.png' },
    ...
    //this.showPalette('android', false);
...
Sidebar.prototype.addMiscPalette = function (expand) {
    ...
    var fns = [
        ...
        this.createVertexTemplateEntry('shape=ellipse;whiteSpace=wrap;html=1;strokeWidth=2;fillWeight=2;hachureGap=8;fillColor=#990000;fillStyle=dots;sketch=1;', 120, 60, '', 'Ellipse Sketch', true, null, 'ellipse oval sketch comic retro'),
        this.createVertexTemplateEntry('shape=rhombus;whiteSpace=wrap;html=1;strokeWidth=2;fillWeight=-1;hachureGap=8;fillStyle=cross-hatch;fillColor=#006600;sketch=1;', 120, 60, '', 'Diamond Sketch', true, null, 'diamond sketch comic retro'),
...
Sidebar.prototype.addStencilPalette = function (id, title, stencilFile, style, ignore, onInit, scale, tags, customFns, groupId) {
    ...
    if (this.addStencilsToIndex) {
        ...
        this.setCurrentSearchEntryLibrary(id,id);
        this.addPaletteFunctions(id, title, false, fns);
